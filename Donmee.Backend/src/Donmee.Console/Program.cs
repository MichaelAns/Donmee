...
options.UseNpgsql("Host=localhost;Port=5432;Database=Donmee;Username=postgres;Password=qwertyfsy");
var dbContext = new DonmeeDbContext(options.Options);

dbContext.Database.EnsureDeleted();
dbContext.Database.EnsureCreated();

Db.AddRange(dbContext);
